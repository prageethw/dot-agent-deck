...
#[test]
fn live_013_rehydration_preserves_shell_synthetic_working() {
...
#[test]
fn live_014_shell_idle_in_the_snapshot_subscribe_window_still_clears_the_card() {
    let rt = tokio::runtime::Builder::new_multi_thread()
        .worker_threads(4)
        .enable_all()
        .build()
        .expect("multi-thread runtime");
    rt.block_on(live_014_shell_idle_in_the_snapshot_subscribe_window_still_clears_the_card_inner());
}

async fn live_014_shell_idle_in_the_snapshot_subscribe_window_still_clears_the_card_inner() {
