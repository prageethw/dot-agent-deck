...
#[test]
fn delegate_029_pi_start_role_delegate_survives_worker_registration_race() {
    tokio::runtime::Builder::new_multi_thread()
        .worker_threads(4)
        .enable_all()
        .build()
        .expect("build startup-race runtime")
        .block_on(delegate_029_pi_start_role_delegate_survives_worker_registration_race_inner());
}

async fn delegate_029_pi_start_role_delegate_survives_worker_registration_race_inner() {
