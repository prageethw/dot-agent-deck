...
#[test]
fn delegate_032_same_role_same_cwd_concurrent_work_done_does_not_clobber() {
    tokio::runtime::Builder::new_multi_thread()
        .worker_threads(2)
        .enable_all()
        .build()
...
#[test]
fn delegate_033_existing_report_survives_and_collision_is_announced() {
    tokio::runtime::Builder::new_multi_thread()
        .worker_threads(2)
        .enable_all()
        .build()
...
#[test]
fn delegate_035_third_collision_destroys_the_first_archived_report() {
    tokio::runtime::Builder::new_multi_thread()
        .worker_threads(2)
        .enable_all()
        .build()
