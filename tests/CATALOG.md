...
- **Platform coverage:** mac+linux (`#[cfg(unix)]` — `DOT_AGENT_DECK_WORKTREE_OWNER`/HOME-relative shell substitution via `/bin/sh -c`, matching `014`'s fixture).
