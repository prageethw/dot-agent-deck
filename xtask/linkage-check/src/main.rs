...
/// printed "9 rules", and issue #259 added a fourteenth check without
...
fn main() -> ExitCode {
    ...
    // the fourteen Decision-7 / Decision-30 / issue #322 / fork #148 / issue #259 checks below.
