...
**Status**: In progress — M1, M2 and M3 landed (process-table primitive + structural discriminator + the pane/daemon wiring, so an agent pane now produces `ShellBusy` for the first time); M4 removed from scope on 2026-08-06 (see Work Log)
