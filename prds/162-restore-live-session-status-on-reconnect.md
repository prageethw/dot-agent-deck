...
**Status**: **Complete.** *(Status corrected 2026-08-14: this line read "changelog + PR/merge pending" for some time after the work had actually shipped. M4.2's changelog fragment landed as `6ee4d5d7` (demo-reel link added in `fb1eb36a`); merged as `dc915486` via [vfarcic/dot-agent-deck#186](https://github.com/vfarcic/dot-agent-deck/pull/186), first released in `v0.32.0`; PRD #120's reconciliation commit `119e5791` had to adapt to this PRD's `live` field already being on `main`, which corroborates that the work had landed.)*
**Priority**: High
**Created**: 2026-06-14
...
- [x] **M4.3** — PR, Greptile review, audit, merge, close. — Done: merged as `dc915486` via [vfarcic/dot-agent-deck#186](https://github.com/vfarcic/dot-agent-deck/pull/186), first released in `v0.32.0`.
