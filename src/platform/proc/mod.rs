...
pub use unix::{
    ...
    force_kill_pid, foreground_pgid, peek_child_exited_without_reaping, pin_process,
    process_table, process_table_async, send_sigterm_to_child_group, spawn_in_new_process_group,
