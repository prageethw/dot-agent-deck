//! `dot-agent-deck daemon status [--json]` — fork #47.
//!
...
/// socket (fork #47 design doc: "cap the CLI's connect/request round trip
...
/// Top-level `--json` document (fork #47 design doc's proposed shape, minus
...
/// text or scrollback (fork #47 design doc) — only the diagnostic fields on
