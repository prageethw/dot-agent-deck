...
| The orchestration command-entry lock: the `Ctrl+E` binding, the keystroke gate on a focused worker pane, and the waiting-pane focus steering — its flag wrapper is deleted and every call site made unconditional. | #393 | issue #302 |
